        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative rounded-xl overflow-hidden shadow-2xl">
              <img
                src="/key326127562.jpg"
                alt="Robin Simon - Berkshire Hathaway HomeServices"
                className="w-full h-auto"
              />
            </div>
            {/* Accent card */}
            <div className="absolute -bottom-6 -right-6 bg-robin-navy text-white p-5 rounded-lg shadow-xl max-w-[200px]">
              <div className="font-display text-3xl font-bold text-bh-gold">15+</div>
              <div className="font-body text-sm text-white/70 mt-1">
                Years serving Queens &amp; Long Island families
              </div>
            </div>
          </div>
