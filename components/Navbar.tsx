      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => handleNav("home")}>
          <div className="flex flex-col leading-tight">
            ...
            <span
              className={`text-[10px] uppercase tracking-[0.25em] font-body font-medium transition-colors ${
                scrolled ? "text-bh-gold" : "text-bh-gold"
              }`}
            >
          ...
          {navItems.map((item) => (
            <button
              ...
              className={`text-sm font-body font-medium transition-all hover:opacity-100 ${
                scrolled
                  ? "text-bh-charcoal hover:text-bh-burgundy"
        ...
        >
          <span
            className={`block w-6 h-0.5 transition-all ${
              scrolled ? "bg-bh-charcoal" : "bg-white"
