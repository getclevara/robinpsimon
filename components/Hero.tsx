    ...
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="animate-fade-up-delay-2 font-body text-lg md:text-xl text-white/75 max-w-2xl mx-auto mb-10 leading-relaxed">
          Market intelligence, neighborhood data, and real insights for buyers and sellers across Queens, Nassau County &amp; Western Suffolk.
        </p>
        ...
        <div className="animate-fade-up-delay-4 mt-16 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-white/40 text-xs font-body uppercase tracking-widest">
          <span>Jericho</span><span className="text-bh-gold/50">&bull;</span>
          <span>Forest Hills</span><span className="text-bh-gold/50">&bull;</span>
          <span>Garden City</span><span className="text-bh-gold/50">&bull;</span>
          <span>Bayside</span><span className="text-bh-gold/50">&bull;</span>
          <span>Melville</span><span className="text-bh-gold/50">&bull;</span>
